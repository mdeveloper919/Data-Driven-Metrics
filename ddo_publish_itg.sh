...
DDM=DDOMISC.github.houston.entsvcs.net
...
# Pushes new dist files to DDOMISC.github.houston.entsvcs.net repository
cd $RUNDIR/$DDM
git add .
...
if $? = 1
	then exit
    echo "Publish of DDOMISC.github.houston.entsvcs.net failed at git push!"
else
    echo "Publish of DDOMISC.github.houston.entsvcs.net succeeded!"
